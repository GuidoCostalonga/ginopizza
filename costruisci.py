  ...
  <div class="contenitore">
    <div class="annuncio annuncio--ritratto obliquo">
      ...
      <img class="ritratto" src="ritratto.jpg""" + impronta("ritratto.jpg") + """" width="900" height="687"
           alt="Ritratto a fumetto di Guido Costalonga: testa pelata, barba, occhiali dalla montatura spessa, giacca blu con la coccarda tricolore. Alle spalle un televisore a tubo catodico con le antenne, acceso, che manda in onda una mano che porge una pizza sotto la scritta GinoPizza, un mobiletto e una parete di legno.">
    </div>
